...
module.exports = {
    VERSION: 'v7.3.6',
    CHANNEL: 'https://t.me/remterplugin',
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Karanan public bot' : process.env.ALL_CAPTION,
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '917994873071@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'Karanan' : process.env.BOT_NAME,
