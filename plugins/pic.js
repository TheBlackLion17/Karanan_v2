/* # Exclusively from TheBlackLion17
 */ 
...
if (Config.WORKTYPE == 'private') {
  ...
  Asena.addCommand({ pattern: 'pic ?(.*)', fromMe: true, desc: Lang.RASHI_DESC }, async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: 'TheBlackLion17 ser'})
